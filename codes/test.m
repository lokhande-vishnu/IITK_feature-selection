function test(healthy_old,faulty_old,feature_old,datawidth_old,dataset_old,P_Ranges)
...
score=ones(1,feature);sepcount=0;sep=zeros(1,feature);rej=zeros(1,feature);
